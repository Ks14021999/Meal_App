            ...
            data.meals.forEach(meal => {
                ...
                html += `
                    ...
                    <div class="card-body">
                      ...
                      <a href="detailsPage.html" id = "show-more" onclick="return addMealIdToLocal(${meal.idMeal},'${meal.strMeal}')" class="btn btn-success">See More Details</a>
                      <button type = "submit" onclick = "addTofavorites(${meal.idMeal},'${meal.strMeal}')" class="btn btn-success" style="margin-top: 3%; ">Add To Favorites</button>
                    </div>
                  </div>
                `;
            });
        } else{
            html = `<h3 >Oops! We Found Error 404! Try other then <b style="color:red;">${search_text}</b></h3>` ;
        }
